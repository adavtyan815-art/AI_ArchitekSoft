...
/** Quick call / Telegram / WhatsApp / email links. Server-safe. */
export function ContactLinks({ phone, telegram, whatsapp, email, size = "sm" }: { phone?: string | null; telegram?: string | null; whatsapp?: string | null; email?: string | null; size?: "sm" | "md" }) {
  ...
  if (!tel && !wa && !tg && !email) return <span className="text-sm text-ink-400">No contact details</span>;
  return (
